...
public class NotifyExceptionUtil {
	public static void notify(Context context, Exception exception) {
		...
		if (msg.equals("400")) {
			...
			Toast.makeText(context, "Server internal error", Toast.LENGTH_LONG);
		}
		else {
			Toast.makeText(context, "unknow error", Toast.LENGTH_LONG);
		}
	}
	public static void notify(Context context) {
		Toast.makeText(context, "parse the data error", Toast.LENGTH_LONG);
	}
